...
class Team: UIViewController {
    ...
    func lookforMembers(){
        ...
        else
        {
            ...
            //let url = NSURL(string:"http://192.168.0.15:8888/Outpitch/iOSmembers/members.php")!
            let url = NSURL(string:"http://172.20.10.3:8888/Outpitch/iOSmembers/members.php")!
    ...
    @IBAction func BT_TROPHIES(sender: UIButton) {
        ...
        else
        {
            ...
            //let url = NSURL(string:"http://192.168.0.15:8888/Outpitch/iOStrophies/trophies.php")!
            let url = NSURL(string:"http://172.20.10.3:8888/Outpitch/iOStrophies/trophies.php")!
            let postData:NSData = post.dataUsingEncoding(NSUTF8StringEncoding)!
            ...
            if ( urlData != nil ) {
                ...
                if (res.statusCode >= 200 && res.statusCode < 300)
                {
                    ...
                    if(success == 1)
                    {
                        ...
                        dateStringEnd = "2016-05-18 17:08:01"
    ...
    func isVoted(teamName : String){
        ...
        //let url = NSURL(string:"http://192.168.0.15:8888/Outpitch/iOScheckvoted/checkvoted.php")!
        let url = NSURL(string:"http://172.20.10.3:8888/Outpitch/iOScheckvoted/checkvoted.php")!
        /* let postData:NSData = post.dataUsingEncoding(NSASCIIStringEncoding)! */
        /* NSUTF8StringEncoding : utilisé pour les accents */
        let postData:NSData = post.dataUsingEncoding(NSUTF8StringEncoding)!
    ...
    func leaveTeam(){
        ...
        else
        {
            ...
            //let url = NSURL(string:"http://192.168.0.15:8888/Outpitch/iOSdeletemember/deletemember.php")!
            let url = NSURL(string:"http://172.20.10.3:8888/Outpitch/iOSdeletemember/deletemember.php")!
            let postData:NSData = post.dataUsingEncoding(NSUTF8StringEncoding)!
