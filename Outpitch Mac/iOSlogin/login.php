...
$reponse1 = $bdd->query(" SELECT* FROM Player WHERE Username ='$pseudo' AND Password = '$mdp' ");
...
$reponse7 = $bdd->query(" SELECT COUNT(ID_Player) FROM Link_Player_Team WHERE ID_Player = '$idPlayer' ");
