...
class Members: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    /*
     Recover data of your friend using is pseudo 
     Put all his data in global value and send theme in the class Friend with
     the prepareforsegue methode.
     */
    func myFriend(){
        ...
        let url = NSURL(string:"http://localhost:8888/Outpitch/iOSfriend/friend.php")!
