...
class Join: UIViewController {
    ...
    /*
     Exactly same architecture than Create, we juste change request in php file.
     */
    ...
    @IBAction func BT_JOIN(sender: UIButton) {
        ...
        else
        {
            ...
            let url = NSURL(string:"http://localhost:8888/Outpitch/iOSjoin/join.php")!
    ...
    /*
     Works as Create. But Alert value is changed to 1, because message won't be '...create...'
     but '...join...'
     */
