...
class Friend: UIViewController {
    ...
    // Link of  the view variables IV: ImageView, LBL: labels that are used in this view for displaying:
    // The users Goals, Assists, etc. in the cross view.
    // The users Goals, Assists etc. to compoare with his friends Stats.
    // The user's friend stats, like for example LBL_FRIEND_GOALS
    // There is also Piecharts for displaying the comparison between the user's stats and his friends' .
    ...
    /* All those tabs are used to set up the Piecharts:
     - compare is used for displaying "Him" and "You" on the charts
     - goalsCompared, assistsCompared... are used to store the user's stat and his friend in the same tab.
     */
    ...
    override func viewDidLoad() {
        ...
        // We set the Compared tabs with the appropriate values, casted in Double
        ...
        // We call the setChart function for each comparison, modifying the Piechart concerned and the tabs used.
    ...
    /* The setChart function is not exactly the same as the one in Profile.
     We added a new parameter, chart, that is a PieChartView.
     We create a dataEntries array that will be filled with the values and their index
     We set the data of the chart,, its description text and disable the legends, and set up the colors to be red for the oponent and green for user's data
     */
