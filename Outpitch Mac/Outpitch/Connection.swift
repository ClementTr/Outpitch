    ...
    @IBAction func BT_CONNECTION(sender: UIButton) {
        ...
        if( username.isEqualToString("") || password.isEqualToString("") ){
            ...
            /*
             ...
             Here, 'pseudo' and 'mdp' have to be present in php file, they will take respectively values
             of 'username' and 'password'.
             You can see in the directory where there is the php file that there is also an html file.
             This is just a file we used in order to test our php requests. It's not usefull now but we decided 
             to let it in order to show our way to build our app.
             */
            ...
            if ( urlData != nil ) {
                ...
                if (res.statusCode >= 200 && res.statusCode < 300){
                    ...
                    if(success == 1){
                        ...
                        /*
                         Allow use automatic connection, put it to one to stay connect even when you leave the app.
                         */
                        ...
                        /*
                         If there is a problem, we show an alert message (mean success is different from 1)
                         Either the username is not existing or the password is wrong
                         */
